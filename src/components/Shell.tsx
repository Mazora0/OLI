...
import { Building2, CreditCard, Globe2, Home, LayoutDashboard, LogIn, LogOut, Menu, MoonStar, Palette, Settings, Shield, Sparkles, SunMedium, Wand2, X } from 'lucide-react';
...
export function Shell({ children }: { children: ReactNode }) {
  ...
  const nav = useMemo(() => [
    ['/', t.home, Home], ['/dashboard', t.dashboard, LayoutDashboard], ['/tools', t.tools, Wand2], ['/pricing', t.pricing, CreditCard], ['/company', t.company, Building2], ['/settings', t.settings, Settings], ['/legal', t.legal, Shield]
  ] as const, [t]);
